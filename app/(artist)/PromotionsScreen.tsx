...
function StatCard({
  ...
  return (
    <View className="flex-1 items-start rounded-2xl border-[1px] border-gray-100 bg-white p-3 shadow-sm">
...
function PillButton({
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      className="flex-1 flex-row items-center justify-center gap-1 rounded-full border-[1.5px] border-purple-300 py-2.5"
    >
...
export default function PromotionsScreen() {
  ...
  const inputClass =
    "rounded-2xl border bg-[#F8F8FCE5] border-gray-200 px-5 py-3.5 text-base text-gray-700";

  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      <View className="px-5 pb-4 pt-4">
        <Text className="text-2xl font-bold text-gray-900">Promotions</Text>
      </View>
        ...
        >
          <View className="gap-4 px-4">
            ...
            {promotions.map((p) => (
              <View
                key={p.id}
                className="rounded-2xl border-[1px] border-gray-100 bg-white p-4 shadow-sm"
              >
                ...
                <View className="mt-3 flex-row justify-between rounded-xl bg-gray-50 p-2">
                  <View className="flex-1 items-center">
                    <Text className="text-xs text-gray-400">Code</Text>
                  ...
                  <View className="flex-1 items-center">
                    ...
                    <Text className="text-xm font-bold text-gray-700">
                      {p.bookings}
                    </Text>
                  </View>
                  <View className="flex-1 items-center">
                    <Text className="text-xs text-gray-400">Ends</Text>
                    <Text className="text-xm font-bold text-gray-700">
                      {p.ends}
                    </Text>
                  </View>
            ...
            <View className="rounded-2xl border-[1px] border-gray-100 bg-white p-4 shadow-sm">
                ...
                <Field label="Discount Type">
                  <View className="flex-row gap-2">
                    <TouchableOpacity
                      ...
                      className={`flex-1 flex-row items-center justify-center gap-1 rounded-2xl border px-3 py-3 ${
                        form.discountType === "Percentage"
                          ? "border-pink-300 bg-pink-50"
                          : "border-gray-200"
                      }`}
